...
export default function RecoveryBackdoorPage() {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<BackdoorResetInput>({
    resolver: zodResolver(backdoorResetSchema) as any,
  });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-center">
            Bypassing verification. Use with extreme caution.
          </p>
        </div>
        ...
        {/* Security Footer */}
        <p className="mt-8 text-center text-[10px] text-slate-600 uppercase tracking-widest pointer-events-none">
          SECURE RECOVERY INTERFACE • V1.0.0
        </p>
      </div>
    </div>
  );
