      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-2xl border border-slate-200 dark:border-slate-700/50 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[75vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-700/50">
            <div>
              <p className="text-sm font-semibold text-slate-900 dark:text-slate-200">{copy.activeStatus}</p>
          ...
          {!isSystem && (
            <>
                ...
                <div>
                  ...
                  <input name="slug" defaultValue={config?.slug || ''} required readOnly={isEdit}
                    className={cn(
                      ...
                      isEdit ? "text-slate-500 bg-slate-50 dark:bg-slate-800 cursor-not-allowed" : "text-slate-900 dark:text-slate-200"
                    )}
              ...
              <div className="border-t border-slate-200 dark:border-slate-700/50 pt-4">
                <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-200 mb-3">{copy.fieldConfiguration}</h3>
              ...
              <div className="border-t border-slate-200 dark:border-slate-700/50 pt-4">
                <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-200 mb-3">{copy.returnTypes}</h3>
