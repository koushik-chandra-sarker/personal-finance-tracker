...
export default function Sidebar() {
  ...
  return (
    <aside className={cn(
      'hidden lg:flex flex-col h-screen sticky top-0 border-r border-slate-700/50 bg-slate-900/80 backdrop-blur-xl transition-all duration-300',
      collapsed ? 'w-20' : 'w-64'
    )}>
      {/* Logo */}
      ...
      <div className="p-4 border-t border-slate-700/50">
        <button
          ...
          className="flex items-center justify-center w-full p-2 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 transition-colors"
        >
